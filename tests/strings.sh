...
teststr integer -42 | outputs '-42'
teststr real 0 | outputs '  0.0000000000E+00'
teststr real 3.1416 | outputs '  3.1416000000E+00'
teststr real 6.02e+23 | outputs '  6.0200000000E+23'
teststr real 9.1e-31 | outputs '  9.1000000000E-31'
teststr real -2.718 | outputs ' -2.7180000000E+00'
...
testval '0' real | outputs '  0.0000000000E+00'
testval '3.1416' real | outputs '  3.1416000000E+00'
testval '1e3' real | outputs '  1.0000000000E+03'
testval '1e+3' real | outputs '  1.0000000000E+03'
testval '1E3' real | outputs '  1.0000000000E+03'
testval '1.0e3' real | outputs '  1.0000000000E+03'
testval '1e-3' real | outputs '  1.0000000000E-03'
testval '-1.23e+4' real | outputs ' -1.2300000000E+04'
