...
teststr integer -42 | outputs '-42'
teststr real 0 | outputs '0'
teststr real 3.1416 | outputs '3.1416'
teststr real 6.02e+23 | outputs '6.02e+23'
teststr real 9.1e-31 | outputs '9.1e-31'
teststr real -2.718 | outputs '-2.718'
...
testval '0' real | outputs '0'
testval '3.1416' real | outputs '3.1416'
testval '1e3' real | outputs '1000'
testval '1e+3' real | outputs '1000'
testval '1E3' real | outputs '1000'
testval '1.0e3' real | outputs '1000'
testval '1e-3' real | outputs '0.001'
testval '-1.23e+4' real | outputs '-12300'
