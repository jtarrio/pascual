...
typedef enum enum7 { XICNIL = 1, XICBOOLEAN, XICINTEGER, XICCHAR, XICSTRING, XICENUM} TEXIMMEDIATECLASS;
...
typedef enum enum20 { XCNOTHING = 1, XCIMMEDIATE, XCTOSTRING, XCVARIABLEACCESS, XCFIELDACCESS, XCARRAYACCESS, XCPOINTERACCESS, XCSTRINGCHAR, XCFUNCTIONREF, XCFUNCTIONCALL, XCUNARYOP, XCBINARYOP} TEXPRESSIONCLASS;
...
typedef enum enum23 { TTCBOOLEAN = 1, TTCINTEGER, TTCCHAR, TTCSTRING, TTCTEXT, TTCENUM, TTCRECORD, TTCARRAY, TTCPOINTER, TTCNIL, TTCPOINTERUNKNOWN} TPSTYPECLASS;
...
typedef enum enum33 { TNCTYPE = 1, TNCVARIABLE, TNCENUMVALUE, TNCFUNCTION, TNCSPECIALFUNCTION} TPSNAMECLASS;
typedef enum enum34 { TSFREAD = 1, TSFREADLN, TSFWRITE, TSFWRITELN, TSFSTR, TSFNEW, TSFDISPOSE} TPSSPECIALFUNCTION;
...
typedef enum enum36 { TDCNAME = 1, TDCTYPE, TDCENUM, TDCRECORD, TDCARRAY, TDCCONSTANT, TDCVARIABLE, TDCFUNCTION, TDCWITHVAR, TDCSCOPEBOUNDARY} TPSDEFCLASS;
...
typedef enum enum42 { LHS = 1, RHS} EXPRESSIONTYPE;
...
if (POS == 1) write_s(&CODEGEN.OUTPUT, str_make(4, " = 1"));
}
if (POS == last) break;
++POS;
}
...
PString INPUTFILE;
PString OUTPUTFILE;
enum enum46 { FLAGNONE = 1, FLAGOUTPUT} FLAG;
PString PARAM;
