...
void STARTGLOBALSCOPE() {
  ...
  ADDCONSTANT(MAKECONSTANT(str_make(2, "PI"), EXREALCONSTANT(3.14159)));
  ...
  ADDFUNCTION(MAKEFUNCTION1(str_make(5, "ROUND"), PRIMITIVETYPES.PTREAL, MAKEARG(str_of('X'), PRIMITIVETYPES.PTREAL)));
  ...
  ADDFUNCTION(MAKEFUNCTION1(str_make(5, "TRUNC"), PRIMITIVETYPES.PTREAL, MAKEARG(str_of('X'), PRIMITIVETYPES.PTREAL)));
