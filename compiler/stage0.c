...
void STARTGLOBALSCOPE() {
  ...
  ADDFUNCTION(MAKEPROCEDURE2(str_make(6, "ASSIGN"), MAKEVARARG(str_of('F'), PRIMITIVETYPES.PTTEXT), MAKEARG(str_make(4, "NAME"), PRIMITIVETYPES.PTSTRING)));
  ...
  ADDFUNCTION(MAKEFUNCTION3(str_make(4, "COPY"), PRIMITIVETYPES.PTSTRING, MAKEARG(str_make(3, "STR"), PRIMITIVETYPES.PTSTRING), MAKEARG(str_make(3, "POS"), PRIMITIVETYPES.PTINTEGER), MAKEARG(str_make(3, "NUM"), PRIMITIVETYPES.PTINTEGER)));
  ...
  ADDFUNCTION(MAKEPROCEDURE3(str_make(6, "INSERT"), MAKEARG(str_make(3, "INS"), PRIMITIVETYPES.PTSTRING), MAKEVARARG(str_make(6, "TARGET"), PRIMITIVETYPES.PTSTRING), MAKEARG(str_make(3, "POS"), PRIMITIVETYPES.PTINTEGER)));
  ADDFUNCTION(MAKEFUNCTION1(str_make(6, "LENGTH"), PRIMITIVETYPES.PTINTEGER, MAKEARG(str_make(3, "STR"), PRIMITIVETYPES.PTSTRING)));
  ADDFUNCTION(MAKEFUNCTION2(str_make(3, "POS"), PRIMITIVETYPES.PTINTEGER, MAKEARG(str_make(6, "NEEDLE"), PRIMITIVETYPES.PTSTRING), MAKEARG(str_make(8, "HAYSTACK"), PRIMITIVETYPES.PTSTRING)));
