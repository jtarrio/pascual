...
typedef struct record9 { TEXIMMEDIATECLASS CLS; union { struct { PBoolean BOOLEANVALUE; }; struct { int INTEGERVALUE; }; struct { char CHARVALUE; }; struct { PString STRINGVALUE; }; struct { int ENUMORDINAL; }; }; } TEXIMMEDIATE;
typedef struct record10 { struct record26 *PARENT; } TEXTOSTRING;
typedef struct record11 { struct record35 *VARIABLEINDEX; } TEXVARIABLEACCESS;
typedef struct record12 { struct record26 *PARENT; int FIELDNUMBER; } TEXFIELDACCESS;
typedef struct record13 { struct record26 *PARENT; struct record26 *SUBSCRIPT; } TEXARRAYACCESS;
typedef struct record14 { struct record26 *PARENT; } TEXPOINTERACCESS;
typedef struct record15 { struct record26 *PARENT; struct record26 *SUBSCRIPT; } TEXSTRINGCHAR;
typedef struct record16 { struct record36 *FUNCTIONINDEX; } TEXFUNCTIONREF;
typedef struct record17 { int SIZE; struct record26 *VALUES[4]; } TEXFUNCTIONARGS;
typedef struct record18 { struct record26 *FUNCTIONREF; TEXFUNCTIONARGS ARGS; } TEXFUNCTIONCALL;
typedef struct record19 { TPSSPECIALFUNCTION SPECIALFUNCTION; } TEXSPECIALFUNCTIONREF;
typedef struct record20 { struct record26 *ARG; struct record20 *NEXT; } TEXREADARGS;
typedef struct record21 { struct record26 *ARG; struct record21 *NEXT; } TEXWRITEARGS;
typedef struct record22 { struct record26 *SRC; struct record26 *DST; struct record26 *PTR; TPSSPECIALFUNCTION SPECIALFUNCTION; union { struct { struct record20 *READARGS; }; struct { struct record21 *WRITEARGS; }; }; } TEXSPECIALFUNCTIONCALL;
typedef struct record23 { struct record26 *PARENT; TLXTOKENID OP; } TEXUNARYOP;
typedef struct record24 { struct record26 *LEFT; struct record26 *RIGHT; TLXTOKENID OP; } TEXBINARYOP;
...
typedef struct record26 { struct record29 *TYPEINDEX; PBoolean ISCONSTANT; PBoolean ISASSIGNABLE; PBoolean ISFUNCTIONRESULT; TEXPRESSIONCLASS CLS; union { struct { TEXIMMEDIATE IMMEDIATEEX; }; struct { TEXTOSTRING TOSTRINGEX; }; struct { TEXVARIABLEACCESS VARIABLEEX; }; struct { TEXFIELDACCESS FIELDEX; }; struct { TEXARRAYACCESS ARRAYEX; }; struct { TEXPOINTERACCESS POINTEREX; }; struct { TEXSTRINGCHAR STRINGCHAREX; }; struct { TEXFUNCTIONREF FUNCTIONEX; }; struct { TEXFUNCTIONCALL CALLEX; }; struct { TEXSPECIALFUNCTIONREF SPECIALFUNCTIONEX; }; struct { TEXSPECIALFUNCTIONCALL SPECIALFUNCTIONCALLEX; }; struct { TEXUNARYOP UNARYEX; }; struct { TEXBINARYOP BINARYEX; }; }; } TEXPRESSIONOBJ;
typedef struct record27 { PString NAME; } TPSIDENTIFIER;
...
typedef struct record29 { PString NAME; struct record29 *ALIASFOR; TPSTYPECLASS CLS; union { struct { struct record30 *ENUMINDEX; }; struct { struct record32 *RECORDINDEX; }; struct { struct record33 *ARRAYINDEX; }; struct { struct record29 *POINTEDTYPEINDEX; }; struct { PString *TARGETNAME; }; }; } TPSTYPE;
typedef struct record30 { int SIZE; PString VALUES[128]; int ID; PBoolean HASBEENDEFINED; } TPSENUMDEF;
typedef struct record31 { PString NAME; struct record29 *TYPEINDEX; } TPSRECORDFIELD;
typedef struct record32 { int SIZE; TPSRECORDFIELD FIELDS[32]; int NUMVARIANTS; int VARIANTBOUNDS[32]; int ID; PBoolean HASBEENDEFINED; } TPSRECORDDEF;
typedef struct record33 { struct record26 *LOWBOUND; struct record26 *HIGHBOUND; struct record29 *TYPEINDEX; } TPSARRAYDEF;
typedef struct record34 { PString NAME; TLXTOKEN REPLACEMENT; } TPSCONSTANT;
typedef struct record35 { PString NAME; struct record29 *TYPEINDEX; PBoolean ISREFERENCE; PBoolean ISCONSTANT; } TPSVARIABLE;
typedef struct record36 { PString NAME; int ARGCOUNT; TPSVARIABLE ARGS[4]; struct record29 *RETURNTYPEINDEX; PBoolean ISDECLARATION; } TPSFUNCTION;
typedef struct record37 { struct record35 *VARIABLEINDEX; } TPSWITHVAR;
typedef enum enum38 { TNCTYPE, TNCVARIABLE, TNCENUMVALUE, TNCFUNCTION, TNCSPECIALFUNCTION} TPSNAMECLASS;
typedef struct record39 { PString NAME; TPSNAMECLASS CLS; union { struct { struct record29 *TYPEINDEX; }; struct { struct record35 *VARIABLEINDEX; }; struct { struct record29 *ENUMTYPEINDEX; int ORDINAL; }; struct { struct record36 *FUNCTIONINDEX; }; struct { TPSSPECIALFUNCTION SPECIALFUNCTION; }; }; } TPSNAME;
...
typedef struct record41 { struct record41 *PREV; struct record41 *NEXT; TPSDEFCLASS CLS; union { struct { struct record39 *NAMEINDEX; }; struct { struct record29 *TYPEINDEX; }; struct { struct record30 *ENUMINDEX; }; struct { struct record32 *RECORDINDEX; }; struct { struct record33 *ARRAYINDEX; }; struct { struct record34 *CONSTANTINDEX; }; struct { struct record35 *VARIABLEINDEX; }; struct { struct record36 *FUNCTIONINDEX; }; struct { struct record37 *WITHVARINDEX; }; struct { PBoolean TEMPORARYSCOPE; struct record36 *CURRENTFUNCTION; }; }; } TPSDEFENTRY;
typedef struct record42 { struct record41 *LATEST; struct record36 *CURRENTFUNCTION; int COUNTER; } TPSDEFS;
...
TPSDEFS DEFS;
struct record43 { struct record29 *PTNIL; struct record29 *PTBOOLEAN; struct record29 *PTINTEGER; struct record29 *PTCHAR; struct record29 *PTSTRING; struct record29 *PTTEXT; } PRIMITIVETYPES;
int DEFCOUNTER() {
...
DEF->CLS = CLS;
switch (CLS) {
case TDCNAME: DEF->NAMEINDEX = malloc(sizeof(struct record39));
break;
case TDCTYPE: DEF->TYPEINDEX = malloc(sizeof(struct record29));
break;
case TDCENUM: DEF->ENUMINDEX = malloc(sizeof(struct record30));
break;
case TDCRECORD: DEF->RECORDINDEX = malloc(sizeof(struct record32));
break;
case TDCARRAY: DEF->ARRAYINDEX = malloc(sizeof(struct record33));
break;
case TDCCONSTANT: DEF->CONSTANTINDEX = malloc(sizeof(struct record34));
break;
case TDCVARIABLE: DEF->VARIABLEINDEX = malloc(sizeof(struct record35));
break;
case TDCFUNCTION: DEF->FUNCTIONINDEX = malloc(sizeof(struct record36));
break;
case TDCWITHVAR: DEF->WITHVARINDEX = malloc(sizeof(struct record37));
break;
...
break;
case XCSPECIALFUNCTIONCALL: _DISPOSESPECIALCALLEXPR(&(*EXPR)->SPECIALFUNCTIONCALLEX);
break;
...
break;
case XCSPECIALFUNCTIONREF: COPY->SPECIALFUNCTIONEX = EXPR->SPECIALFUNCTIONEX;
break;
case XCSPECIALFUNCTIONCALL: _COPYSPECIALCALLEXPR(&EXPR->SPECIALFUNCTIONCALLEX, &COPY->SPECIALFUNCTIONCALLEX);
break;
case XCUNARYOP: {
...
case TSFREAD: return_PSFUNCTIONCALL = PSREAD(FN);
break;
case TSFREADLN: return_PSFUNCTIONCALL = PSREAD(FN);
break;
case TSFWRITE: return_PSFUNCTIONCALL = PSWRITE(FN);
break;
case TSFWRITELN: return_PSFUNCTIONCALL = PSWRITE(FN);
break;
case TSFSTR: return_PSFUNCTIONCALL = PSSTR(FN);
break;
case TSFNEW: return_PSFUNCTIONCALL = PSNEW(FN);
break;
case TSFDISPOSE: return_PSFUNCTIONCALL = PSDISPOSE(FN);
break;
default: break;
}
}
...
struct record48 { PFile OUTPUT; PBoolean ISMULTISTATEMENT; int INDENT; PBoolean NEWLINE; TOUTPUTTYPE LASTOUT; } CODEGEN;
void _OUTNEWLINE() {
{
...
break;
case XICBOOLEAN: if ((*with49).BOOLEANVALUE) {
...
break;
case XICCHAR: _OUTCHAR((*with49).CHARVALUE);
break;
case XICSTRING: _OUTSTRING(&(*with49).STRINGVALUE);
break;
case XICENUM: {
...
case TSFWRITE: _OUTWRITE(EXPR);
break;
case TSFWRITELN: _OUTWRITE(EXPR);
break;
case TSFREAD: _OUTREAD(EXPR);
break;
case TSFREADLN: _OUTREAD(EXPR);
break;
case TSFSTR: _OUTSTR(EXPR);
break;
case TSFNEW: _OUTNEW(EXPR);
break;
case TSFDISPOSE: _OUTDISPOSE(EXPR);
break;
default: break;
}
}
