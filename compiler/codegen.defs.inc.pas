...
forward;
procedure OutRead(Src : TExpression; OutVar : TExpression);
forward;
procedure OutReadln(Src : TExpression);
forward;
procedure OutWrite(Dst : TExpression; Expr : TExpression);
forward;
procedure OutWriteln(Dst : TExpression);
forward;
procedure OutStr(Dst : TExpression; Expr : TExpression);
forward;
procedure OutNew(Dst : TExpression);
forward;
procedure OutDispose(Dst : TExpression);
forward;
